...
public class MainSceneMenuController : MonoBehaviour
{
	...
	[SerializeField] TMP_Text coinsText, gemText;
	private int coins;
	...
	{
		coinsText.SetText(GameDataManager.Instance.coins.ToString());
		gemText.SetText(GameDataManager.Instance.gems.ToString());
